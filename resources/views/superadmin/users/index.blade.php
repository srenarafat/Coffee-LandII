...
<div class="container my-4">
    ...
    <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover align-middle mb-0">
                   <thead class="custom-header text-center align-middle">
                        ...
                        @foreach ($users as $key => $user)
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="badge bg-{{ $user->role === 'superadmin' ? 'primary' : ($user->role === 'admin' ? 'info' : 'success') }}">
                                        🎖️ {{ $user->role === 'superadmin' ? __('Super_admin') : ucfirst($user->role) }}
                                    </span>
                                </td>
                                <td class="text-center">
